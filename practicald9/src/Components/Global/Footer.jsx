...
import { FOOTER_ICONS } from "./Footer/Footer_Icon";


function Footer() {
	return(
	<section className="bg-[#051114] w-[100%]">
	 <section className="flex flex-wrap  justify-start items-center lg:justify-around gap-12 py-12 w-[90%] m-auto font-inter">
		<article className="flex flex-col gap-4 lg:w-[350px]">
		<svg
							width='152'
							height='51'
							viewBox='0 0 152 51'
						...
						<p className="text-[16px] text-white font-extralight opacity-65">Lorem ipsum dolor sit amet, consect etur adipiscing elit. Ullamcorper purus eleifend purus faucibus faucibus.</p>
						<div className="flex gap-5">
							<div className="border-white border-[0.5px]  rounded-[50%] h-[41px] w-[41px] flex justify-center items-center border-opacity-30 ">
						{FOOTER_ICONS.TWITTER}
						</div>
						<div className="border-white border-[0.5px]  rounded-[50%] h-[41px] w-[41px] flex justify-center items-center border-opacity-30 ">{FOOTER_ICONS.FACEBOOK}</div>
						<div className="border-white border-[0.5px]  rounded-[50%] h-[41px] w-[41px] flex justify-center items-center border-opacity-30 ">{FOOTER_ICONS.INSTAGRAM}</div>
						<div className="border-white border-[0.5px]  rounded-[50%] h-[41px] w-[41px] flex justify-center items-center border-opacity-30 ">{FOOTER_ICONS.LINKEDIN}</div>
		...
		<p className="font-medium text-white">Usefull links</p>
				...
				<article className="flex flex-col gap-5 lg:w-[340px]">
